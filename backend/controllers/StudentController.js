...
exports.loginStudent = async (req, res) => {
    ...
    try {
        ...
        if(student){
            ...
            if(validPassword){
                res.status(200).json({message: 'Login successful', studentFirstName: student.studentFirstName, lastName: student.studentLastName, studentId: student.studentId, group: student.group, role: student.role});
            }else{
